...
const texture = loader.load('/textura.jpg')
...
const pointLight = new THREE.PointLight('#00d3ff', 3)
...
document.addEventListener('mousemove', animateTerrian)

let mouseY = 0 
function animateTerrian(event){
